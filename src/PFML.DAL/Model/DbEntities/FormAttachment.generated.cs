...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public static class FormAttachmentExtension
    {
        ...
        public static List<FormAttachmentDto> ToDtoListDeep(this IEnumerable<FormAttachment> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
        ...
        /// <param name="dbContext">DB Context to use for setting state of DTO</param>
        /// <returns>List of DTO FormAttachments</returns>
        public static List<FormAttachmentDto> ToDtoListDeep(this IQueryable<FormAttachment> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
            List<FormAttachmentDto> dtos = new List<FormAttachmentDto>();
            foreach (FormAttachment entity in entities)
        ...
        public static List<T> ToDtoListDeep<T>(this IQueryable<FormAttachment> entities, FACTS.Framework.DAL.DbContext dbContext) where T : FormAttachmentDto, new()
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
