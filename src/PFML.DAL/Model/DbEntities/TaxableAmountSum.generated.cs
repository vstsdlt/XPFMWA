...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public class TaxableAmountSum : BaseEntity
    {
        ...
        public TaxableAmountSumDto ToDtoDeep(FACTS.Framework.DAL.DbContext dbContext, TaxableAmountSumDto dto = null, Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = null)
        {
    ...
    public static class TaxableAmountSumExtension
    {
        ...
        public static List<TaxableAmountSumDto> ToDtoListDeep(this IEnumerable<TaxableAmountSum> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
        ...
        /// <param name="dbContext">DB Context to use for setting state of DTO</param>
        /// <returns>List of DTO TaxableAmountSums</returns>
        public static List<TaxableAmountSumDto> ToDtoListDeep(this IQueryable<TaxableAmountSum> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
            List<TaxableAmountSumDto> dtos = new List<TaxableAmountSumDto>();
            foreach (TaxableAmountSum entity in entities)
        ...
        public static List<T> ToDtoListDeep<T>(this IQueryable<TaxableAmountSum> entities, FACTS.Framework.DAL.DbContext dbContext) where T : TaxableAmountSumDto, new()
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
