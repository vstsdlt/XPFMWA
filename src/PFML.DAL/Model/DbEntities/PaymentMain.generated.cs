...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public static class PaymentMainExtension
    {
        ...
        public static List<PaymentMainDto> ToDtoListDeep(this IEnumerable<PaymentMain> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
        ...
        /// <param name="dbContext">DB Context to use for setting state of DTO</param>
        /// <returns>List of DTO PaymentMains</returns>
        public static List<PaymentMainDto> ToDtoListDeep(this IQueryable<PaymentMain> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
            List<PaymentMainDto> dtos = new List<PaymentMainDto>();
            foreach (PaymentMain entity in entities)
        ...
        public static List<T> ToDtoListDeep<T>(this IQueryable<PaymentMain> entities, FACTS.Framework.DAL.DbContext dbContext) where T : PaymentMainDto, new()
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
