...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public static class WageUnitDetailExtension
    {
        ...
        public static List<WageUnitDetailDto> ToDtoListDeep(this IEnumerable<WageUnitDetail> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
        ...
        /// <param name="dbContext">DB Context to use for setting state of DTO</param>
        /// <returns>List of DTO WageUnitDetails</returns>
        public static List<WageUnitDetailDto> ToDtoListDeep(this IQueryable<WageUnitDetail> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
            List<WageUnitDetailDto> dtos = new List<WageUnitDetailDto>();
            foreach (WageUnitDetail entity in entities)
        ...
        public static List<T> ToDtoListDeep<T>(this IQueryable<WageUnitDetail> entities, FACTS.Framework.DAL.DbContext dbContext) where T : WageUnitDetailDto, new()
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
