...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public class SecurityDefinition : BaseEntity
    {
        ...
        public SecurityDefinitionDto ToDtoDeep(FACTS.Framework.DAL.DbContext dbContext, SecurityDefinitionDto dto = null, Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = null)
        {
    ...
    public static class SecurityDefinitionExtension
    {
        ...
        public static List<SecurityDefinitionDto> ToDtoListDeep(this IEnumerable<SecurityDefinition> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
        ...
        /// <param name="dbContext">DB Context to use for setting state of DTO</param>
        /// <returns>List of DTO SecurityDefinitions</returns>
        public static List<SecurityDefinitionDto> ToDtoListDeep(this IQueryable<SecurityDefinition> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
            List<SecurityDefinitionDto> dtos = new List<SecurityDefinitionDto>();
            foreach (SecurityDefinition entity in entities)
        ...
        public static List<T> ToDtoListDeep<T>(this IQueryable<SecurityDefinition> entities, FACTS.Framework.DAL.DbContext dbContext) where T : SecurityDefinitionDto, new()
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
