...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public static class SecurityPermissionExtension
    {
        ...
        public static List<SecurityPermissionDto> ToDtoListDeep(this IEnumerable<SecurityPermission> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
        ...
        /// <param name="dbContext">DB Context to use for setting state of DTO</param>
        /// <returns>List of DTO SecurityPermissions</returns>
        public static List<SecurityPermissionDto> ToDtoListDeep(this IQueryable<SecurityPermission> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
            List<SecurityPermissionDto> dtos = new List<SecurityPermissionDto>();
            foreach (SecurityPermission entity in entities)
        ...
        public static List<T> ToDtoListDeep<T>(this IQueryable<SecurityPermission> entities, FACTS.Framework.DAL.DbContext dbContext) where T : SecurityPermissionDto, new()
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
