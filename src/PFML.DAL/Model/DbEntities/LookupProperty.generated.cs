...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public static class LookupPropertyExtension
    {
        ...
        public static List<LookupPropertyDto> ToDtoListDeep(this IEnumerable<LookupProperty> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
        ...
        /// <param name="dbContext">DB Context to use for setting state of DTO</param>
        /// <returns>List of DTO LookupProperties</returns>
        public static List<LookupPropertyDto> ToDtoListDeep(this IQueryable<LookupProperty> entities, FACTS.Framework.DAL.DbContext dbContext)
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
            List<LookupPropertyDto> dtos = new List<LookupPropertyDto>();
            foreach (LookupProperty entity in entities)
        ...
        public static List<T> ToDtoListDeep<T>(this IQueryable<LookupProperty> entities, FACTS.Framework.DAL.DbContext dbContext) where T : LookupPropertyDto, new()
        {
            Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto> entityDtos = new Dictionary<BaseEntity, FACTS.Framework.Dto.BaseDto>();
