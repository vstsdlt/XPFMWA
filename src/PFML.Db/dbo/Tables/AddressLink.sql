CREATE TABLE [dbo].[AddressLink] (
    ...
    CONSTRAINT [FK_AddressLink_EmployerUnit_EmployerUnitSeqNo] FOREIGN KEY ([EmployerId], [EmployerUnitSeqNo]) REFERENCES [dbo].[EmployerUnit] ([EmployerId], [EmployerUnitSeqNo])
);
